...
async function BookPage({ searchParams }: Props) {
    ...
    const initialTreatment = paramsObj.treatment ? parseInt(paramsObj.treatment as string) : undefined;
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <BookingFlow treatments={data.treatments} totalPages={data.totalPages} initialTreatment={initialTreatment} />
        </div>
    )
}
